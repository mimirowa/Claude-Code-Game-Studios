...
SNAPSHOT_FILE="production/session-state/compact-snapshot.md"
if [ -f "$SNAPSHOT_FILE" ]; then
    echo ""
    echo "A pre-compaction snapshot is available at: $SNAPSHOT_FILE"
    echo "Read it when recovering work after context compaction."
fi
